...
class ServerValidationExceptionTest {
    ...
    void shouldCreateExceptionWithMessageOnly() {
        ...
        assertThat(exception.getFormattedMessage()).isEqualTo("Server validation failed: Request validation failed");
    ...
    void shouldCreateExceptionWithMessageAndFailedLayer() {
        ...
        assertThat(exception.getErrorCode()).isEqualTo("OPEN_AGENT_AUTH_11_0301");
        assertThat(exception.getFormattedMessage()).isEqualTo("Server validation failed: Layer 2 validation failed");
    ...
    void shouldCreateExceptionWithMessageAndCause() {
        ...
        assertThat(exception.getErrorCode()).isEqualTo("OPEN_AGENT_AUTH_11_0301");
        assertThat(exception.getFormattedMessage()).isEqualTo("Server validation failed: Cannot validate request");
    ...
    void shouldCreateExceptionWithMessageFailedLayerAndCause() {
        ...
        assertThat(exception.getErrorCode()).isEqualTo("OPEN_AGENT_AUTH_11_0301");
        assertThat(exception.getFormattedMessage()).isEqualTo("Server validation failed: Layer 3 validation failed");
